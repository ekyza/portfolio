...
export default function ScrollToTopButton({ showScrollTop }: ScrollToTopButtonProps) {
  return (
    <button
      ...
      className={`
          fixed bottom-12 md:bottom-32 right-6 md:right-32 z-50 bg-primary dark:bg-dark-primary rounded-full flex justify-center items-center p-1 transition-all duration-500 ease-in-out transform ${
